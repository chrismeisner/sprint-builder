...
export default function SignupNamePage() {
  ...
  const [addAsDriver, setAddAsDriver] = useState(true);
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (Object.keys(errs).length === 0) {
      router.push("/scan-device?from=signup");
    }
  }
      ...
      <div className="flex w-full max-w-sm flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-base font-normal leading-normal text-pretty text-neutral-600 dark:text-neutral-400">
            This is how you&rsquo;ll appear in the app. You can also add yourself as a driver if you use the vehicle.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <input
                ...
                name="addAsDriver"
                checked={addAsDriver}
                onChange={(e) => setAddAsDriver(e.target.checked)}
                className="h-4 w-4 rounded border-neutral-300 accent-blue-600 dark:border-neutral-600"
              />
