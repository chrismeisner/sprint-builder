...
const checklist: ChecklistStep[] = [
  {
    id: "route",
    label: "Saving route data",
    description: "Capturing your full route and waypoints",
    delay: 0,
    duration: 2000,
  },
  {
    id: "details",
    label: "Processing trip details",
    description: "Distance, duration, and driving patterns",
    delay: 2000,
    duration: 2500,
  },
  {
    id: "sync",
    label: "Syncing remaining data",
    description: "Filling in any gaps from the drive",
    delay: 4500,
    duration: 3000,
  },
  {
    id: "summary",
    label: "Building your trip summary",
...
export default function TripFinalizingPage() {
  ...
  useEffect(() => {
    ...
    timers.push(
      setTimeout(() => setAllDone(true), lastStep.delay + lastStep.duration + 500)
    );
      ...
      <div className="mx-auto flex w-full max-w-sm flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          <h1 className="text-4xl font-semibold leading-tight text-balance text-neutral-900 dark:text-neutral-100">
            {allDone ? "Trip saved" : "Finalizing your trip"}
          </h1>
          <p className="text-base font-normal leading-normal text-pretty text-neutral-600 dark:text-neutral-400">
            {allDone
              ? "Everything\u2019s in. Your trip summary is ready to view."
              : "Your drive just ended. Miles is wrapping up the details \u2014 this only takes a moment."}
          </p>
        </div>
          ...
          <div className="flex gap-3 rounded-md border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-950">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm font-normal leading-normal text-green-700 dark:text-green-400">
                All data is in. Your full trip summary is ready.
              </span>
            </div>
          </div>
        )}

        {/* Processing hint — shown while working */}
        {!allDone && (
          <div className="flex gap-3 rounded-md border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950">
            ...
            <span className="text-sm font-normal leading-normal text-blue-700 dark:text-blue-400">
              This usually takes under a minute. You can close the app and
        ...
        <div className="flex flex-col gap-3">
          {allDone ? (
            ...
            >
              Close &mdash; I&rsquo;ll check later
            </Link>
          )}
        </div>
      </div>
