      ...
      <div className="mx-auto flex w-full max-w-sm flex-col gap-8">
        ...
        <div className="relative flex aspect-video items-end justify-end overflow-hidden rounded-md border border-neutral-200 bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-800">
          ...
          <div className="absolute inset-0 opacity-5">
            <div className="absolute left-[10%] top-[60%] h-px w-[80%] bg-neutral-900 dark:bg-neutral-100" />
            <div className="absolute left-[40%] top-[20%] h-[60%] w-px bg-neutral-900 dark:bg-neutral-100" />
            <div className="absolute left-[70%] top-[10%] h-[50%] w-px bg-neutral-900 dark:bg-neutral-100" />
          </div>
