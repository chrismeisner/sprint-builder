...
import { MARKER_LABEL } from "@/app/sandboxes/miles-proto-5/_lib/vehicle-tokens";
import {
  METRIC_ICONS,
  getVehicleData,
  useVehicleNickname,
  type VehicleData,
  type MetricTile,
} from "@/app/sandboxes/miles-proto-5/_lib/vehicle-data";
...
export function VehicleDetailBody({ vehicleId }: { vehicleId: string }) {
  ...
  const [healthView] = useLocalStorageState<"bento" | "carousel">(
    `miles-proto-5-vehicle-health-view-${vehicle.id}`,
    "bento"
  );
