...
import type {
  ...
  AgentCard,
  ChatMessage,
} from "@/app/sandboxes/miles-proto-5/_lib/agent-types";
import {
  CONTEXTS,
  PENDING_ITEMS,
  getAgentResponse,
} from "@/app/sandboxes/miles-proto-5/_lib/agent-data";
import {
  AgentCardView,
  SuggestedPrompts,
  UserBubble,
} from "@/app/sandboxes/miles-proto-5/_components/agent-card";
