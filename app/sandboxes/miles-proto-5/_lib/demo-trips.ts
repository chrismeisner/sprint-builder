...
export const TRIP_VEHICLES = ["All", "Civic", "RAV4", "Kit's RAM"] as const;
export const TRIP_TYPES = ["All", "Trips", "Events"] as const;
/** Preset date scopes — maps to SwiftUI `Picker(.segmented)` on iOS. */
export const TRIP_DATE_RANGES = ["All", "Today", "Yesterday", "This week", "Custom"] as const;
