...
import { useLocalStorageState } from "@/app/sandboxes/miles-proto-5/_lib/use-local-storage-state";
...
const VEHICLES: Record<string, VehicleData> = {
  civic: {
    ...
    trips: [
      { id: "t1", from: "New Hope, PA",    to: "Lambertville, NJ", date: "Today",     timeRange: "3:42 – 3:54 PM", distance: "4.2 mi",  duration: "12 min", score: 88, events: 1, driver: "Christina", driverInitials: "CM", vehicle: "Civic" },
      { id: "t2", from: "Lambertville, NJ", to: "New Hope, PA",     date: "Today",     timeRange: "4:30 – 4:41 PM", distance: "4.1 mi",  duration: "11 min", score: 92, events: 0, driver: "Christina", driverInitials: "CM", vehicle: "Civic" },
      { id: "t3", from: "New Hope, PA",     to: "Princeton, NJ",    date: "Yesterday", timeRange: "8:05 – 8:32 AM", distance: "11.3 mi", duration: "27 min", score: 79, events: 2, driver: "Emma",      driverInitials: "ER", vehicle: "Civic" },
    ],
  },
  rav4: {
    id: "rav4",
    ...
    imageSrc: "/api/sandbox-files/miles-proto-5/public/images/rav4.jpg",
    ...
    trips: [
      { id: "t4", from: "Frenchtown, NJ", to: "Stockton, NJ",  date: "Today",     timeRange: "5:45 – 6:02 PM", distance: "3.8 mi", duration: "17 min", score: 85, events: 0, driver: "Jack", driverInitials: "JM", vehicle: "RAM" },
      { id: "t5", from: "New Hope, PA",   to: "Pennington, NJ", date: "Yesterday", timeRange: "6:15 – 6:38 PM", distance: "8.9 mi", duration: "23 min", score: 81, events: 1, driver: "Jack", driverInitials: "JM", vehicle: "RAM" },
      { id: "t6", from: "Buckingham, PA", to: "Solebury, PA",   date: "Yesterday", timeRange: "3:15 – 3:35 PM", distance: "5.7 mi", duration: "20 min", score: 87, events: 1, driver: "Emma", driverInitials: "ER", vehicle: "RAM" },
    ],
  },
};
...
export function useVehicleNickname(vehicleId: string): string {
  ...
  const [nickname] = useLocalStorageState(
    `miles-proto-5-vehicle-nickname-${vehicle.id}`,
    vehicle.nickname
  );
  return nickname;
}
