...
import { InlineEditField } from "@/app/sandboxes/miles-proto-5/_components/inline-edit-field";
import { PrototypeNote } from "@/app/sandboxes/miles-proto-5/_components/prototype-note";
import { useLocalStorageState } from "@/app/sandboxes/miles-proto-5/_lib/use-local-storage-state";
import { getVehicleData } from "@/app/sandboxes/miles-proto-5/_lib/vehicle-data";
...
function VehicleDetailsContent() {
  ...
  const [plate, setPlate] = useLocalStorageState(
    `miles-proto-5-vehicle-plate-${vehicle.id}`,
    vehicle.registration.plate
  );
  const [plateState] = useLocalStorageState(
    `miles-proto-5-vehicle-plate-state-${vehicle.id}`,
