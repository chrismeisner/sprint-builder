...
import { BASE } from "@/app/sandboxes/miles-proto-5/_lib/nav";
...
const NOTIFS: Record<string, NotifDef> = {
  ...
  "coaching-braking": {
    ...
    body: "A hard braking event on River Rd cost you 3 points. Ask Miles for tips.",
...
function AppIcon() {
  return (
    ...
    <img
      src="/miles-proto-5/miles-icon.svg"
      alt="Miles"
...
function NotificationContent() {
  ...
  return (
    <div className="relative flex h-dvh flex-col text-white overflow-hidden select-none">
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/miles-proto-5/images/bg.jpg"
        alt=""
