...
import { useForceLightMode, setForceLightMode } from "@/app/sandboxes/miles-proto-5/_components/force-light-mode";
import { useMilesSheet } from "@/app/sandboxes/miles-proto-5/_components/miles-sheet";
...
import {
  MARKER_LABEL,
  vehicleAccentByName,
} from "@/app/sandboxes/miles-proto-5/_lib/vehicle-tokens";
import { SymbolIcon } from "@/app/sandboxes/miles-proto-5/_components/symbol-icon";

const FOOTER_NAV_MODE_STORAGE_KEY = "miles-proto-5-footer-nav-mode";
...
const AVATAR_MOM = "/miles-proto-5/images/mom.jpg";
const AVATAR_TEEN = "/miles-proto-5/images/teen.jpg";

/* ------------------------------------------------------------------ */
/*  iOS Type Scale Reference — 18 roles                               */
/*  Source of truth: lib/design-system/ios-typography.ts              */
/*  Hub reference:  /sandboxes/miles-proto-5/hub (Typography section) */
/*                                                                     */
...
const VEHICLES: Vehicle[] = [
  {
    ...
    locationLabel: "12 Bridge St, New Hope, PA",
    locationType: "saved",
    ...
    lastTrip: {
      driver: "Christina",
      from: "Bridge St & Main St, New Hope, PA",
      to: "73 N Union St, Lambertville, NJ",
      time: "Today, 3:42 PM",
    ...
    priorTrips: [
      {
        driver: "Christina",
        from: "73 N Union St, Lambertville, NJ",
  ...
  },
  {
    ...
    locationLabel: "Bridge St & Union St, Lambertville, NJ",
    ...
    lastTrip: {
      driver: "Emma",
      from: "Bridge St & Main St, New Hope, PA",
      to: "Bridge St & Union St, Lambertville, NJ",
      time: "Today, 5:18 PM",
    ...
    priorTrips: [
      {
        driver: "Jack",
        from: "Home Depot",
        to: "Bridge St & Main St, New Hope, PA",
        time: "Today, 2:14 PM",
      ...
      {
        driver: "Jack",
        from: "Bridge St & Union St, Lambertville, NJ",
        to: "Lowe's",
      ...
      <div className="relative mx-5 overflow-hidden rounded-panel">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent px-4 pb-3 pt-8">
          <div className="flex items-center gap-4 text-background/80">
            ...
            <span className="text-background/40">&middot;</span>
            <span className="text-xs font-medium">Bridge St & Main St, New Hope, PA &rarr; ...</span>
          </div>
        </div>
      </div>
      ...
      <div className="mx-5 flex flex-col gap-3 rounded-panel border border-stroke-muted bg-surface-subtle p-4">
        <div className="flex items-start gap-3">
          ...
          <p className="flex-1 font-mono text-sm leading-relaxed text-text-secondary">
            One hard braking event on River Rd. Leaving a little more following distance can help — want tips?
          </p>
        </div>
...
function DashboardContent() {
  ...
  function setNavMode(mode: FooterNavMode) {
    ...
    try {
      ...
      window.dispatchEvent(new Event("miles-proto-5-footer-nav-mode-change"));
    } catch {
