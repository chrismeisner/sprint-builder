...
export default function TripIndicatorPage() {
  ...
  return (
    <main className="flex min-h-dvh flex-col bg-neutral-200">
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col">
          ...
          <div className="flex gap-3 rounded-lg bg-white/80 p-3 shadow-sm">
            ...
            <div className="flex flex-1 flex-col gap-0.5">
              ...
              <span className="text-xs font-normal leading-normal text-neutral-600">
                Trip recording started on your 2022 Honda CR-V
              </span>
            </div>
          </div>
        </div>
        ...
        {/* Spacer — pushes Live Activity to bottom */}
        <div className="flex-1" />

        {/* Live Activity anchored to bottom */}
        <div className="flex flex-col gap-2 px-4 pb-[33%]">

          {/* Live Activity — tappable → opens live trip */}
          <Link
            href="/live-trip"
          ...
          >
            {/* Header: app icon + name + recording badge */}
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5 rounded-full bg-green-100 px-2 py-1">
                <span className="relative flex size-2">
                  <span className="absolute inline-flex size-full rounded-full bg-green-500 opacity-75 motion-safe:animate-ping" />
