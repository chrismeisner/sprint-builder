...
function WelcomeModal({ onDismiss }: { onDismiss: () => void }) {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center bg-neutral-900/60 px-8 dark:bg-neutral-950/75"
      onClick={onDismiss}
    >
      <div
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm font-normal leading-relaxed text-neutral-600 dark:text-neutral-400">
              Ready to install Miles in your car? Plug it into your OBD-II port and every drive will be tracked automatically. Takes about 5 minutes.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2.5">
              {[
                "Your Miles device",
                "Access to your car\u2019s OBD-II port",
                "Your car keys (to turn on and pair)",
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-2.5">
                  <div className="flex size-5 shrink-0 items-center justify-center rounded-full border border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800">
...
function DashboardContent() {
  ...
  const state: "empty" | "no-trips" | "filled" =
    stateParam === "empty" ? "empty" :
    stateParam === "no-trips" ? "no-trips" :
    "filled";
      ...
      <div className="mx-auto flex w-full max-w-sm flex-col gap-8">
        ...
        {(state === "filled" || state === "no-trips") ? (
          <>
            ...
            {/* From Miles — contextual insights carousel (only when trips exist) */}
            {state === "filled" && <FromMiles />}
            ...
            <div className="flex flex-col gap-3">
              ...
              {state === "no-trips" ? (
                /* First drive nudge */
                <div className="flex flex-col gap-4 rounded-xl border border-blue-200 bg-blue-50 p-5 dark:border-blue-900 dark:bg-blue-950">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <span className="text-sm font-semibold leading-none text-blue-800 dark:text-blue-300">
                        Ready for your first drive
                      </span>
                      <span className="text-xs font-normal leading-normal text-blue-600 dark:text-blue-400">
                        Miles is connected and waiting to log trips
                      </span>
                    </div>
                  </div>
                  <p className="text-sm font-normal leading-relaxed text-blue-700 dark:text-blue-400">
                    Just get in your car and drive. Miles will automatically detect and record the trip — no buttons to press.
                  </p>
                </div>
              ) : (
                <Link
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="flex flex-col gap-1 rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
                  <span className="text-xs font-normal leading-normal text-neutral-500 dark:text-neutral-500">Trips</span>
                  <span className={`text-xl font-semibold leading-snug tabular-nums ${state === "filled" ? "text-neutral-900 dark:text-neutral-100" : "text-neutral-300 dark:text-neutral-600"}`}>
                    {state === "filled" ? "1" : "0"}
                  </span>
                </div>
                <div className="flex flex-col gap-1 rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
                  <span className="text-xs font-normal leading-normal text-neutral-500 dark:text-neutral-500">Miles</span>
                  <span className={`text-xl font-semibold leading-snug tabular-nums ${state === "filled" ? "text-neutral-900 dark:text-neutral-100" : "text-neutral-300 dark:text-neutral-600"}`}>
                    {state === "filled" ? "4.2" : "0"}
                  </span>
                </div>
                <div className="flex flex-col gap-1 rounded-md border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800">
                  <span className="text-xs font-normal leading-normal text-neutral-500 dark:text-neutral-500">Time</span>
                  <span className={`text-xl font-semibold leading-snug tabular-nums ${state === "filled" ? "text-neutral-900 dark:text-neutral-100" : "text-neutral-300 dark:text-neutral-600"}`}>
                    {state === "filled" ? "12m" : "0m"}
                  </span>
                </div>
