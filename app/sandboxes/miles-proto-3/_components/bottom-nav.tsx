...
function BottomNavInner() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("miles-proto-3-footer-nav-mode-change", handleCustomChange);
    return () => {
      window.removeEventListener("storage", handleStorage);
      window.removeEventListener("miles-proto-3-footer-nav-mode-change", handleCustomChange);
    };
  }, []);
