    ...
    <main className="flex min-h-dvh flex-col bg-neutral-50 pb-24">
      ...
      <div className="flex items-center gap-3 px-5 pt-6 pb-2">
        ...
        <div className="flex flex-1 flex-col gap-0.5">
          <h1 className="text-lg font-semibold text-neutral-900">To-Do</h1>
      ...
      {/* Filter pills */}
      <div className="flex gap-2 overflow-x-auto px-5 pb-4 pt-2 scrollbar-none">
      ...
      <div className="mt-6 px-5">
        <div className="flex items-center gap-3 rounded-xl border border-dashed border-neutral-200 bg-white px-4 py-3.5 text-neutral-400">
          ...
          <span className="text-sm">Items are added from maintenance schedules, the Miles agent, or manually</span>
        </div>
      </div>
    </main>
  );
