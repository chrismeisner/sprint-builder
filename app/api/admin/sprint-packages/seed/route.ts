    ...
    const packages: PackageDefinition[] = [
      {
        ...
        description: "A complete brand identity system in 2 weeks. Kicks off with a Day 1 workshop to align on goals and strategy, then delivers logo, typography, colors, and comprehensive brand guidelines.",
      ...
      },
      {
        ...
        description: "Validate direction and launch a product or feature in 2 weeks. Day 1 workshop aligns on priorities, then we build a high-converting landing page and interactive prototype to test with users.",
      ...
      {
        id: `pkg-${randomBytes(8).toString("hex")}`,
        name: "Investor Deck Sprint",
        slug: "investor-deck-extend-sprint",
        description: "Ship an investor-ready story fast. Day 1 workshop realigns on the narrative, then we deliver a full deck polish plus supporting assets so you can run your fundraise with confidence.",
      ...
      {
        id: `pkg-${randomBytes(8).toString("hex")}`,
        name: "Launch Landing Page Sprint",
        slug: "launch-landing-page-extend-sprint",
        description: "Create a launch moment fast. Day 1 workshop locks the positioning, then we ship a single-scroll launch page, automated waitlist, and ready-to-post announcements so you can start collecting demand immediately.",
      ...
      {
        id: `pkg-${randomBytes(8).toString("hex")}`,
        name: "Browser MVP Prototype Sprint",
        slug: "browser-mvp-prototype-extend-sprint",
        description: "Turn a validated idea into a browser-based MVP prototype. Day 1 workshop aligns on flows and constraints, then we create interactive screens, implementation notes, and a test plan to validate the concept within days.",
      ...
      },
      {
        ...
        description: "Deepen or refine an existing prototype based on feedback. Day 1 workshop prioritizes what to change, then we integrate notes, up-level the UX, and ship polished release notes so your team knows exactly what changed.",
