...
export const iosTypographyScale: IosTypographyToken[] = [
  ...
  // ─── Body ──────────────────────────────────────────────────────────────────
  {
    ...
    usage: "Key data — driver name in strips, max speed in trip header, route names",
  ...
  },
  {
    ...
    usage: "Bento stat values — Score, Engine status, Fuel % · Driver strip speed (secondary mph)",
