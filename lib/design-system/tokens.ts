...
export const typographyScale: TypographyToken[] = [
  {
    ...
    fontFamily: "Gooper SemiCondensed",
    fontWeight: "Regular 400",
    baseClass: "font-gooper-semicondensed font-normal tracking-[-0.01em]",
    desktop: {
      sizeClass: "text-[5rem]",
      pixels: "80px",
      rem: "5rem",
  ...
  },
  {
    ...
    baseClass: "font-general font-light tracking-[0rem]",
    desktop: {
      sizeClass: "text-[2rem]",
      pixels: "32px",
      rem: "2rem",
  ...
  },
  {
    ...
    fontFamily: "General Grotesque",
    fontWeight: "Book 400",
    baseClass: "font-general font-normal tracking-[-0.02em]",
    desktop: {
  ...
  },
  {
    ...
    fontFamily: "Inter",
    fontWeight: "Regular 400",
    baseClass: "font-inter tracking-[0.019rem]",
    desktop: {
  ...
  },
  {
    ...
    fontFamily: "General Grotesque Mono",
    fontWeight: "Light 300",
    baseClass: "font-general-mono font-light uppercase tracking-[0rem]",
    desktop: {
      sizeClass: "text-[1.25rem]",
      pixels: "20px",
      rem: "1.25rem",
  ...
  },
  {
    ...
    fontFamily: "General Grotesque Mono",
    fontWeight: "Light 300",
    baseClass: "font-general-mono font-light uppercase tracking-[0.021rem]",
    desktop: {
  ...
  },
  {
    ...
    fontFamily: "General Grotesque Mono",
    fontWeight: "Light 300",
    baseClass: "font-general-mono font-light uppercase tracking-[0.031rem]",
    desktop: {
      sizeClass: "text-[0.81rem]",
      pixels: "13px",
      rem: "0.81rem",
